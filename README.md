...
在抖音上刷到一个油管博主讲 AI 开发，被吸引住了，想试试自己能不能也搞一个。

从零到一的进化路线：

1. 向大模型发起 API 调用
2. 用 `pip install` 安装 SDK，写 10 行代码，发送提示词，打印 AI 响应
3. 把调用封装成函数，接收用户输入
...
从 GitHub [python-mini-projects](https://github.com/Python-World/python-mini-projects) 上 clone 的练习项目集合，包含 100+ 个小工具，涵盖爬虫、自动化、GUI、游戏、图像处理等各种方向，供学习参考。
